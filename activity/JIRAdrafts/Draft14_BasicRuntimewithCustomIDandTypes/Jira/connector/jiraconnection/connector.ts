                                            ...
                                            for (let fieldName in jsonRespFields) {
                                                if(notAllowedFields.indexOf(fieldName) < 0) {
                                                    ...
                                                    if(jsonRespFields[fieldName].required){
                                                        reqFields[jsonRespFields[fieldName].name] = JsonSchema.Types.toJsonType(jsonRespFields[fieldName].schema, fieldName )
                                                        requiredFields.push(jsonRespFields[fieldName].name)
                                                    } else {
                                                        optFields[jsonRespFields[fieldName].name] = JsonSchema.Types.toJsonType(jsonRespFields[fieldName].schema, fieldName)
                                                    }
